schemes = { @(N, M, x, tau, lambda, K, T, sigma, q, q_delta, g, g1, g2, phi, option) BTCS(N, M, x, tau, lambda, K, T, sigma, q, q_delta, g, g1, g2, phi, option);
            @(N, M, x, tau, lambda, K, T, sigma, q, q_delta, g, g1, g2, phi, option) CTCS(N, M, x, tau, lambda, K, T, sigma, q, q_delta,g,  g1, g2, phi, option)}; 

scheme_names = ["BTCS", "CTCS"];
...
for i = 1 : length(schemes)
    ...
    [V2, S2, t2] = schemes{i}(N, M, x, tau, lambda, K, T, sigma, q, q_delta, g, g1, g2, phi, 'call');
