...
for i = 1 : length(schemes)
    ...
    [V, S, t] = schemes{i}(N, M, x, tau, lambda, K, T, sigma, q, q_delta, g, g1, g2, phi, 'put');
    ...
    [N_list, error, delta_x, delta_t] = calculate_error(a, b, K, T, sigma, q, q_delta, r, g, g1, g2, phi, schemes{i}, i, 'put');
